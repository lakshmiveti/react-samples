...
echo 'Now...'
echo 'Visit http://localhost:7777 to see your Node.js/React application in action.'
echo '(This is why you specified the "args ''-p 7777:7777''" parameter when you'
